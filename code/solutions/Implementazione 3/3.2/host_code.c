...
int main (int argc, char *argv[]) {
	...
	//N Work-Item da Lanciare inizialmente
	...
	while (n_sott>0) {
		...
		if (flag == 1) {
			ev[n_iterazioni]= sort (que, parallel_q, d_v1, delimiters, app, 0, NULL,(n_sott*max_sott_size), max_sott_size);
